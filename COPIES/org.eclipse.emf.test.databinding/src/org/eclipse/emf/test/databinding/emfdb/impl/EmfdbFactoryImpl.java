...
public class EmfdbFactoryImpl extends EFactoryImpl implements EmfdbFactory
{
  ...
  public <T extends EObject> T create(EClass<T> eClass)
  {
    ...
    {
      case EmfdbPackage.A: return (T) createA();
      case EmfdbPackage.B: return (T) createB();
      case EmfdbPackage.C: return (T) (EObject)createC();
      case EmfdbPackage.D: return (T) createD();
      case EmfdbPackage.E: return (T) createE();
      default:
