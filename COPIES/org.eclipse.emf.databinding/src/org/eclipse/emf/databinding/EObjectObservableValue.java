 ...
 */
public class EObjectObservableValue<T> extends AbstractObservableValue<T> implements IObserving
{
  /**
   * The object instance
   */
   ...
   * The feature
   */
  protected EStructuralFeature<?, T> eStructuralFeature;
  /**
   * The listener
   */
   ...
   *            the feature
   */
  public <S extends EObject> EObjectObservableValue(S eObject, EStructuralFeature<? super S, T> eStructuralFeature)
  {
   ...
   *            the feature
   */
  public <S extends EObject> EObjectObservableValue(Realm realm, S eObject, EStructuralFeature<? super S, T> eStructuralFeature)
  {
    super(realm);
    ...
    listener = new AdapterImpl()
      {
        ...
        public void notifyChanged(Notification notification)
        {
          if (eStructuralFeature == notification.getFeature() && !notification.isTouch())
          {
            ...
            final ValueDiff<T> diff = Diffs.createValueDiff((T) notification.getOldValue(), (T) notification.getNewValue());
