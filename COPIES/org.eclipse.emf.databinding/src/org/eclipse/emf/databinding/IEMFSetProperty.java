 ...
 */
public interface IEMFSetProperty<S extends EObject, E> extends IEMFProperty, ISetProperty<S, E> {
	/**
	 ...
	 */
	public <T> IEMFMapProperty<S, E, T> values(EStructuralFeature<? super E, T> feature);
     ...
     * @see #values(IEMFValueProperty)
     */
  public <T> IEMFMapProperty<S, E, T> values(FeaturePath<? super E, T> featurePath);
	 ...
	 *         value property.
	 */
  public <T> IEMFMapProperty<S, E, T> values(IEMFValueProperty<? super E, T> property);
}
