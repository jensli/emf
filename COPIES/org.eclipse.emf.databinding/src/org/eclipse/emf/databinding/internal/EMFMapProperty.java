 ...
 * @since 2.5
 */
public class EMFMapProperty<S extends EObject, K, V> extends SimpleMapProperty<S, K, V>
{
  private EStructuralFeature<S, Map<K, V>> eStructuralFeature;
  ...
  protected Map<K, V> doGetMap(S source)
  {
    ...
    return ((EMap<K, V>)eObj.eGet(eStructuralFeature)).map();
  }
