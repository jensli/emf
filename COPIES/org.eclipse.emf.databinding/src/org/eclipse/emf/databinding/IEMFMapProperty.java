 ...
 */
public interface IEMFMapProperty<S extends EObject, K, V> extends IEMFProperty, IMapProperty<S, K, V>
{
   ...
   */
  public <T> IEMFMapProperty<S, K, T> values(FeaturePath<? super V, T> featurePath);
   ...
   * @see #values(IEMFValueProperty)
   */
  public <T> IEMFMapProperty<S, K, T> values(EStructuralFeature<? super V, T> feature);
   ...
   *         value property.
   */
  public <T> IEMFMapProperty<S, K, T> values(IEMFValueProperty<? super V, T> property);

  @Override
  public EStructuralFeature<S, Map<K, V>> getStructuralFeature();
}
