 ...
 */
public class FeaturePath<S extends EObject, V>
{
  ...
  {
    return new FeaturePath<EObject, Object>(featurePath);
  }

  
  public static <T1 extends EObject, T2> FeaturePath<T1, T2> fromList(
    EStructuralFeature<T1, T2> f1)
  {
    return new FeaturePath<T1, T2>(f1);
  }

  public static <T1 extends EObject, T2 extends EObject, T3 extends EObject, T4> FeaturePath<T1, T4> fromList(
    EStructuralFeature<T1, T2> f1,
    EStructuralFeature<T2, T3> f2,
    EStructuralFeature<T3, T4> f3)
  {
    return new FeaturePath<T1, T4>(f1, f2, f3);
  }
  
  @SuppressWarnings("unchecked")
  public EStructuralFeature<S, ?> getFirst() {
    return (EStructuralFeature<S, ?>) featurePath[0];
  }
  
  @SuppressWarnings("unchecked")
  public EStructuralFeature<?, V> getLast() {
    return (EStructuralFeature<?, V>) featurePath[featurePath.length - 1];
  }
