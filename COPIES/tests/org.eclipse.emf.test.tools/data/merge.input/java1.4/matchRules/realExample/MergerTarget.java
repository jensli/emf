...
import com.ibm.vista.re.asl.administerreminderrules.response.ifc.ILoadReminderRulesResponse;    
 ...
 * @generated "1.3.14/Nov 24, 2006 9:11:17 AM"
...
public class ReAdministerReminderRulesASPValidator extends AbstractBaseASPValidator {
   ...
   * <!--end-user-doc-->
   *
   * @service loadReminderRules
   * @serviceType load 
   * @uuid (__q-awFHqEdugi_DC_0ZCCg)
   * @generated "1.3.14/Nov 24, 2006 9:11:17 AM"
   */
  public boolean preValidateLoadReminderRules(ILoadReminderRulesResponse pResponse) throws VistaFunctionalException {
     if (isDebugEnabled()){
      logDebug(IVistaConstants.MSG_METHOD_ENTRY, new Object[]{"preValidateLoadReminderRules", this.getClass().getName()});
    } // End If
    ...
    // end-user-code  
    if (isDebugEnabled()){
      logDebug(IVistaConstants.MSG_METHOD_EXIT, new Object[]{"preValidateLoadReminderRules", this.getClass().getName()});
    } // End If
    return validationSuccessful;
  } // End of Method - preValidateLoadReminderRules
   ...
   * @generated "1.3.14/Nov 24, 2006 9:11:17 AM"
   */
  public boolean postValidateLoadReminderRules(ILoadReminderRulesResponse pResponse) throws VistaFunctionalException {
    if (isDebugEnabled()){  
      logDebug(IVistaConstants.MSG_METHOD_ENTRY, new Object[]{"postValidateLoadReminderRules", this.getClass().getName()});
    } // End If
    boolean postValidationSuccessful = true;
    // begin-user-code
    // end-user-code  
    if (isDebugEnabled()){
      logDebug(IVistaConstants.MSG_METHOD_EXIT, new Object[]{"postValidateLoadReminderRules", this.getClass().getName()});
    } // End If
    return postValidationSuccessful;
  } // End of Method - postValidateLoadReminderRules
   ...
   *
   * TODO_GEN add method comment here
   * @param pReminderRulesList TODO_GEN add parameter description here
   * @return TODO_GEN add description here
   * @pre $none
   * @post $none 
   *
   ...
   * @generated "1.3.14/Nov 24, 2006 9:11:17 AM"
   */
  public boolean preValidateSaveReminderRules(IReReminderTemplateAEList pReminderRulesList, ISaveReminderRulesResponse pResponse) throws VistaFunctionalException {
    //target
     if (isDebugEnabled()){
    ...
    validationSuccessful = super.validateParametersAreNotNull(new String[] {"pReminderRulesList"}, new Object[] {pReminderRulesList}, pResponse); 
    // end-user-code  
    if (isDebugEnabled()){
   ...
   * @generated "1.3.14/Nov 24, 2006 9:11:17 AM"
   */
  public boolean postValidateSaveReminderRules(IReReminderTemplateAEList pReminderRulesList, ISaveReminderRulesResponse pResponse) throws VistaFunctionalException {
    if (isDebugEnabled()){  
