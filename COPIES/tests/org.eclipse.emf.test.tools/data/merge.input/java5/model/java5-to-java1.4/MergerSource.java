...
public class WriterImpl extends EObjectImpl implements Writer
{
   ...
   * @ordered
   */
  protected static final String NAME_EDEFAULT = "Default Name"; //$NON-NLS-1$
  ...
  public EList getLibraries()
  {
    if (libraries == null)
    {
      libraries = new EObjectWithInverseEList.ManyInverse(Library.class, this, LibraryPackage.WRITER__LIBRARIES, LibraryPackage.LIBRARY__WRITERS);
    }
    return libraries;
  }
