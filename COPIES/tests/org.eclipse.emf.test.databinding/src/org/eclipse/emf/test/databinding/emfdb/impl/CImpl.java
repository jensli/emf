 ...
 * @generated
 */
public class CImpl extends EObjectImpl implements BasicEMap.Entry<String,String>
{
  /**
  ...
  {
    return EmfdbPackage.Literals.C;
  }
  ...
  public void setTypedKey(String newKey)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EmfdbPackage.C__KEY, oldKey, key));
  }
  ...
  public void setTypedValue(String newValue)
  {
    ...
    value = newValue;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, EmfdbPackage.C__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case EmfdbPackage.C__KEY:
        return getTypedKey();
      case EmfdbPackage.C__VALUE:
