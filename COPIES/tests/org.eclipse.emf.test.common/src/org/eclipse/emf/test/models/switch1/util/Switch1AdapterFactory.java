 ...
 * @generated
 */
public class Switch1AdapterFactory extends AdapterFactoryImpl
{
  /**
   ...
   * @generated
   */
  protected Switch1Switch<Adapter> modelSwitch =
    new Switch1Switch<Adapter>()
    {
      @Override
