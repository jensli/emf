 ...
 * @generated
 */
public class Switch3AdapterFactory extends AdapterFactoryImpl
{
  /**
   ...
   * @generated
   */
  protected Switch3Switch<Adapter> modelSwitch =
    new Switch3Switch<Adapter>()
    {
      @Override
      public Adapter caseEClass4(EClass4 object)
      {
        return createEClass4Adapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.emf.test.models.switch3.EClass4 <em>EClass4</em>}'.
   * <!-- begin-user-doc -->
   ...
   * @generated
   */
  public Adapter createEClass4Adapter()
  {
    return null;
  }

  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.emf.test.models.switch3.EClass5 <em>EClass5</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
