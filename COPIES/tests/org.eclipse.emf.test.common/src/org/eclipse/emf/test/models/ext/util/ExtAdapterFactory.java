...
public class ExtAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected ExtSwitch<Adapter> modelSwitch =
    ...
    {
      @Override
      public Adapter caseExtE(ExtE object)
      {
        return createExtEAdapter();
      }
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.emf.test.models.ext.ExtE <em>E</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.emf.test.models.ext.F <em>F</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
