    ...
    IItemPropertySource		
{
  ...
  public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(URefPackage.Literals.C4U__CU);
      childrenFeatures.add(URefPackage.Literals.C4U__DU);
    }
  ...
  {
    return overlayImage(object, getResourceLocator().getImage("full/obj16/C4U"));
  }
  ...
  protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object)
  {
    ...
    newChildDescriptors.add
      (createChildParameter
        (URefPackage.Literals.C4U__CU,
         URefFactory.eINSTANCE.createCU()));

    newChildDescriptors.add
      (createChildParameter
        (URefPackage.Literals.C4U__DU,
