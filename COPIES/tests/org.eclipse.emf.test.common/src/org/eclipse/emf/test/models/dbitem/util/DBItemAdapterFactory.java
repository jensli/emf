 ...
 * @generated
 */
public class DBItemAdapterFactory extends AdapterFactoryImpl
{
  /**
   ...
   * @generated
   */
  protected DBItemSwitch<Adapter> modelSwitch =
    new DBItemSwitch<Adapter>()
    {
      @Override
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.emf.test.models.dbitem.DbType <em>Db Type</em>}'.
   * <!-- begin-user-doc -->
  ...
  /**
   * Creates a new adapter for an object of class '{@link org.eclipse.emf.test.models.dbitem.DocumentRoot <em>Document Root</em>}'.
   * <!-- begin-user-doc -->
   * This default implementation returns null so that we can easily ignore cases;
   * it's useful to ignore a case when inheritance will catch all the cases anyway.
   * <!-- end-user-doc -->
