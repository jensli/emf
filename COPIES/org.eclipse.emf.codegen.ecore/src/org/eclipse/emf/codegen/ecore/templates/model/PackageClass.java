...
public class PackageClass
{
  ...
  protected final String TEXT_277 = NL + "\t/**" + NL + "\t * Returns the meta object for the ";
  protected final String TEXT_278 = " '{@link ";
  protected final String TEXT_279 = "#";
  protected final String TEXT_280 = " <em>";
  protected final String TEXT_281 = "</em>}'." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the meta object for the ";
  protected final String TEXT_282 = " '<em>";
  protected final String TEXT_283 = "</em>'." + NL + "\t * @see ";
  protected final String TEXT_284 = "#";
  protected final String TEXT_285 = "()";
  protected final String TEXT_286 = NL + "\t * @see #get";
  protected final String TEXT_287 = "()" + NL + "\t * @generated" + NL + "\t */";
  ...
  protected final String TEXT_298 = "().getEStructuralFeatures().get(";
  ...
  protected final String TEXT_307 = NL + "\t/**" + NL + "\t * Returns the meta object for the '{@link ";
  protected final String TEXT_308 = "#";
  protected final String TEXT_309 = "(";
  protected final String TEXT_310 = ") <em>";
  protected final String TEXT_311 = "</em>}' operation." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the meta object for the '<em>";
  protected final String TEXT_312 = "</em>' operation." + NL + "\t * @see ";
  protected final String TEXT_313 = "#";
  protected final String TEXT_314 = "(";
  protected final String TEXT_315 = ")" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_316 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  ...
  protected final String TEXT_321 = ".getEOperations().get(";
  protected final String TEXT_322 = ");" + NL + "\t";
  protected final String TEXT_323 = NL + "\treturn get";
  protected final String TEXT_324 = "().getEOperations().get(";
  ...
  protected final String TEXT_333 = NL + "\t/**" + NL + "\t * Returns the factory that creates the instances of the model." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the factory that creates the instances of the model." + NL + "\t * @generated" + NL + "\t */";
  ...
  protected final String TEXT_338 = ")getEFactoryInstance();" + NL + "\t}";
  protected final String TEXT_339 = NL + "\t";
  protected final String TEXT_340 = " get";
  protected final String TEXT_341 = "();";
  protected final String TEXT_342 = NL;
  protected final String TEXT_343 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isCreated = false;" + NL + "" + NL + "\t/**" + NL + "\t * Creates the meta-model objects for the package.  This method is" + NL + "\t * guarded to have no affect on any invocation but its first." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void createPackageContents()" + NL + "\t{" + NL + "\t\tif (isCreated) return;" + NL + "\t\tisCreated = true;" + NL + "\t";
  protected final String TEXT_344 = NL + NL + "\t\t// Create classes and their features" + NL + "\t  ";
  protected final String TEXT_345 = NL + "\t\t";
  protected final String TEXT_346 = " = create";
  protected final String TEXT_347 = "(";
  protected final String TEXT_348 = ");" + NL + "\t";
  protected final String TEXT_349 = NL + "\t\tcreate";
  protected final String TEXT_350 = "(";
  protected final String TEXT_351 = ", ";
  protected final String TEXT_352 = ");" + NL + "\t";
  protected final String TEXT_353 = NL + "\t";
  protected final String TEXT_354 = NL + "\t  ";
  protected final String TEXT_355 = NL + "\t\tcreateEOperation(";
  ...
  protected final String TEXT_364 = NL + NL + "\t\t// Create enums" + NL + "\t  ";
  protected final String TEXT_365 = NL + "\t\t";
  protected final String TEXT_366 = " = createEEnum(";
  protected final String TEXT_367 = ");" + NL + "\t  ";
  protected final String TEXT_368 = NL + "\t";
  protected final String TEXT_369 = NL + "\t";
  protected final String TEXT_370 = NL + NL + "\t\t// Create data types" + NL + "\t  ";
  protected final String TEXT_371 = NL + "\t\t";
  protected final String TEXT_372 = " = createEDataType(";
  protected final String TEXT_373 = ");" + NL + "\t  ";
  protected final String TEXT_374 = NL + "\t";
  protected final String TEXT_375 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isInitialized = false;" + NL;
  protected final String TEXT_376 = NL + "\t/**" + NL + "\t * Complete the initialization of the package and its meta-model.  This" + NL + "\t * method is guarded to have no affect on any invocation but its first." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void initializePackageContents()" + NL + "\t{" + NL + "\t\tif (isInitialized) return;" + NL + "\t\tisInitialized = true;" + NL + "" + NL + "\t\t// Initialize package" + NL + "\t\tsetName(eNAME);" + NL + "\t\tsetNsPrefix(eNS_PREFIX);" + NL + "\t\tsetNsURI(eNS_URI);" + NL + "\t";
  protected final String TEXT_377 = NL + NL + "\t\t// Obtain other dependent packages" + NL + "\t  ";
  protected final String TEXT_378 = NL + "\t\t";
  protected final String TEXT_379 = " ";
  protected final String TEXT_380 = " = (";
  protected final String TEXT_381 = ")";
  protected final String TEXT_382 = ".Registry.INSTANCE.getEPackage(";
  protected final String TEXT_383 = ".eNS_URI);" + NL + "\t  ";
  protected final String TEXT_384 = NL + "\t";
  protected final String TEXT_385 = NL + "\t";
  protected final String TEXT_386 = NL + NL + "\t\t// Add subpackages" + NL + "\t  ";
  protected final String TEXT_387 = NL + "\t\tgetESubpackages().add(";
  protected final String TEXT_388 = ");" + NL + "\t  ";
  protected final String TEXT_389 = NL + "\t";
  protected final String TEXT_390 = NL + "\t";
  protected final String TEXT_391 = NL + "\t  ";
  protected final String TEXT_392 = NL + NL + "\t\t// Create type parameters" + NL + "\t";
  protected final String TEXT_393 = NL + "\t  ";
  protected final String TEXT_394 = NL + "\t";
  protected final String TEXT_395 = NL + "\t\t";
  protected final String TEXT_396 = " ";
  protected final String TEXT_397 = "_";
  protected final String TEXT_398 = " = addETypeParameter(";
  protected final String TEXT_399 = ", \"";
  protected final String TEXT_400 = "\");";
  protected final String TEXT_401 = NL + "\t";
  protected final String TEXT_402 = NL + "\t\taddETypeParameter(";
  ...
  protected final String TEXT_410 = NL + NL + "\t\t// Set bounds for type parameters" + NL + "\t";
  ...
  protected final String TEXT_425 = ".getEBounds().add(g1);" + NL + "\t";
  protected final String TEXT_426 = NL + "\t  ";
  protected final String TEXT_427 = NL + "\t";
  protected final String TEXT_428 = NL + "\t  ";
  protected final String TEXT_429 = NL + NL + "\t\t// Add supertypes to classes" + NL + "\t  ";
  protected final String TEXT_430 = NL + "\t";
  protected final String TEXT_431 = NL + "\t  ";
  protected final String TEXT_432 = NL + "\t\t";
  protected final String TEXT_433 = ".getESuperTypes().add(";
  ...
  protected final String TEXT_440 = "g";
  protected final String TEXT_441 = " = createEGenericType(";
  protected final String TEXT_442 = ");" + NL + "\t  ";
  protected final String TEXT_443 = NL + "\t\tg";
  protected final String TEXT_444 = ".";
  protected final String TEXT_445 = "(g";
  protected final String TEXT_446 = ");" + NL + "\t  ";
  protected final String TEXT_447 = NL + "\t";
  protected final String TEXT_448 = NL + "\t\t";
  protected final String TEXT_449 = ".getEGenericSuperTypes().add(g1);" + NL + "\t  ";
  protected final String TEXT_450 = NL + "\t";
  protected final String TEXT_451 = NL + "\t  ";
  protected final String TEXT_452 = NL + NL + "\t\t// Initialize classes";
  protected final String TEXT_453 = ", features, and operations; add parameters";
  protected final String TEXT_454 = " and features; add operations and parameters";
  protected final String TEXT_455 = NL + "\t  ";
  protected final String TEXT_456 = NL + "\t\tinitEClass(";
  protected final String TEXT_457 = ", ";
  protected final String TEXT_458 = "null";
  protected final String TEXT_459 = ".class";
  ...
  protected final String TEXT_471 = "g";
  protected final String TEXT_472 = " = createEGenericType(";
  protected final String TEXT_473 = ");" + NL + "\t  ";
  protected final String TEXT_474 = NL + "\t\tg";
  ...
  protected final String TEXT_482 = NL + "\t\tinitEReference(get";
  protected final String TEXT_483 = "(), ";
  protected final String TEXT_484 = "g1";
  protected final String TEXT_485 = ".get";
  ...
  protected final String TEXT_504 = NL + "\t\tget";
  protected final String TEXT_505 = "().getEKeys().add(";
  protected final String TEXT_506 = ".get";
  protected final String TEXT_507 = "());" + NL + "\t";
  protected final String TEXT_508 = NL + "\t  ";
  protected final String TEXT_509 = NL + "\t\tinitEAttribute(get";
  protected final String TEXT_510 = "(), ";
  protected final String TEXT_511 = "g1";
  ...
  protected final String TEXT_533 = "initEOperation(get";
  protected final String TEXT_534 = "()";
  protected final String TEXT_535 = "addEOperation(";
  ...
  protected final String TEXT_549 = "initEOperation(get";
  protected final String TEXT_550 = "()";
  protected final String TEXT_551 = "addEOperation(";
  ...
  protected final String TEXT_562 = "initEOperation(get";
  protected final String TEXT_563 = "()";
  protected final String TEXT_564 = "addEOperation(";
  ...
  protected final String TEXT_574 = "initEOperation(get";
  protected final String TEXT_575 = "()";
  protected final String TEXT_576 = "addEOperation(";
  ...
  protected final String TEXT_583 = "addETypeParameter(op, \"";
  protected final String TEXT_584 = "\");";
  protected final String TEXT_585 = NL + "\t  ";
  protected final String TEXT_586 = NL + "\t";
  protected final String TEXT_587 = NL + "\t\t";
  protected final String TEXT_588 = "g";
  protected final String TEXT_589 = " = createEGenericType(";
  protected final String TEXT_590 = ");" + NL + "\t  ";
  protected final String TEXT_591 = NL + "\t\tg";
  protected final String TEXT_592 = ".";
  protected final String TEXT_593 = "(g";
  protected final String TEXT_594 = ");" + NL + "\t  ";
  protected final String TEXT_595 = NL + "\t";
  protected final String TEXT_596 = NL + "\t\tt";
  protected final String TEXT_597 = ".getEBounds().add(g1);" + NL + "\t  ";
  ...
  protected final String TEXT_604 = "g";
  protected final String TEXT_605 = " = createEGenericType(";
  protected final String TEXT_606 = ");" + NL + "\t";
  protected final String TEXT_607 = NL + "\t\tg";
  protected final String TEXT_608 = ".";
  protected final String TEXT_609 = "(g";
  ...
  protected final String TEXT_614 = NL + "\t\taddEParameter(op, ";
  protected final String TEXT_615 = "g1";
  ...
  protected final String TEXT_625 = NL + "\t\taddEParameter(op, ";
  protected final String TEXT_626 = "g1";
  protected final String TEXT_627 = ".get";
  ...
  protected final String TEXT_636 = NL + "\t\taddEParameter(op, ";
  protected final String TEXT_637 = "g1";
  ...
  protected final String TEXT_650 = "g";
  protected final String TEXT_651 = " = createEGenericType(";
  protected final String TEXT_652 = ");" + NL + "\t  ";
  protected final String TEXT_653 = NL + "\t\tg";
  protected final String TEXT_654 = ".";
  protected final String TEXT_655 = "(g";
  protected final String TEXT_656 = ");" + NL + "\t  ";
  protected final String TEXT_657 = NL + "\t\taddEException(op, g";
  ...
  protected final String TEXT_662 = NL + "\t\taddEException(op, ";
  ...
  protected final String TEXT_669 = "g";
  protected final String TEXT_670 = " = createEGenericType(";
  protected final String TEXT_671 = ");" + NL + "\t  ";
  protected final String TEXT_672 = NL + "\t\tg";
  protected final String TEXT_673 = ".";
  protected final String TEXT_674 = "(g";
  protected final String TEXT_675 = ");" + NL + "\t  ";
  protected final String TEXT_676 = NL + "\t";
  protected final String TEXT_677 = NL + "\t\tinitEOperation(op, g1);" + NL + "\t  ";
  ...
  protected final String TEXT_684 = NL + NL + "\t\t// Initialize enums and add enum literals" + NL + "\t  ";
  protected final String TEXT_685 = NL + "\t\tinitEEnum(";
  protected final String TEXT_686 = ", ";
  protected final String TEXT_687 = ".class, \"";
  protected final String TEXT_688 = "\");";
  protected final String TEXT_689 = NL + "\t";
  protected final String TEXT_690 = NL + "\t\taddEEnumLiteral(";
  ...
  protected final String TEXT_699 = NL + NL + "\t\t// Initialize data types" + NL + "\t  ";
  protected final String TEXT_700 = NL + "\t\tinitEDataType(";
  protected final String TEXT_701 = ", ";
  protected final String TEXT_702 = ".class, \"";
  ...
  protected final String TEXT_711 = NL + NL + "\t\t// Create resource" + NL + "\t\tcreateResource(";
  protected final String TEXT_712 = ");" + NL + "\t";
  protected final String TEXT_713 = NL + "\t";
  protected final String TEXT_714 = NL + NL + "\t\t// Create annotations" + NL + "\t  ";
  protected final String TEXT_715 = NL + "\t\t// ";
  protected final String TEXT_716 = NL + "\t\tcreate";
  protected final String TEXT_717 = "Annotations();" + NL + "\t  ";
  protected final String TEXT_718 = NL + "\t";
  protected final String TEXT_719 = NL + "\t}" + NL + "" + NL + "\t";
  protected final String TEXT_720 = NL + "\t/**" + NL + "\t * Initializes the annotations for <b>";
  protected final String TEXT_721 = "</b>." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected void create";
  protected final String TEXT_722 = "Annotations()" + NL + "\t{" + NL + "\t\tString source = ";
  protected final String TEXT_723 = "null;";
  protected final String TEXT_724 = "\"";
  protected final String TEXT_725 = "\";";
  protected final String TEXT_726 = NL + "\t  ";
  protected final String TEXT_727 = NL + "\t";
  protected final String TEXT_728 = "\t" + NL + "\t\taddAnnotation" + NL + "\t\t  (";
  protected final String TEXT_729 = ", " + NL + "\t\t   source, " + NL + "\t\t   new String[] " + NL + "\t\t   {" + NL + "\t  ";
  ...
  protected final String TEXT_737 = NL + "\t\t   new ";
  protected final String TEXT_738 = "[] " + NL + "\t\t   {" + NL + "\t";
  protected final String TEXT_739 = NL + "\t\t\t ";
  protected final String TEXT_740 = ".createURI(";
  protected final String TEXT_741 = ".";
  protected final String TEXT_742 = "eNS_URI).appendFragment(\"";
  ...
  protected final String TEXT_748 = NL + "\t\taddAnnotation" + NL + "\t\t  (";
  protected final String TEXT_749 = ", " + NL + "\t\t   ";
  protected final String TEXT_750 = "new boolean[] { ";
  protected final String TEXT_751 = " }";
  protected final String TEXT_752 = "," + NL + "\t\t   ";
  protected final String TEXT_753 = "null,";
  protected final String TEXT_754 = "\"";
  protected final String TEXT_755 = "\",";
  protected final String TEXT_756 = NL + "\t\t   new String[] " + NL + "\t\t   {" + NL + "\t";
  ...
  protected final String TEXT_764 = NL + "\t\t   new ";
  protected final String TEXT_765 = "[] " + NL + "\t\t   {" + NL + "\t";
  protected final String TEXT_766 = NL + "\t\t\t ";
  protected final String TEXT_767 = ".createURI(";
  protected final String TEXT_768 = ".";
  protected final String TEXT_769 = "eNS_URI).appendFragment(\"";
  ...
  protected final String TEXT_779 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isLoaded = false;" + NL + "" + NL + "\t/**" + NL + "\t * Laods the package and any sub-packages from their serialized form." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void loadPackage()" + NL + "\t{" + NL + "\t\tif (isLoaded) return;" + NL + "\t\tisLoaded = true;" + NL + "" + NL + "\t\t";
  protected final String TEXT_780 = " url = getClass().getResource(packageFilename);" + NL + "\t\tif (url == null)" + NL + "\t\t{" + NL + "\t\t\tthrow new RuntimeException(\"Missing serialized package: \" + packageFilename);";
  protected final String TEXT_781 = NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_782 = " uri = ";
  protected final String TEXT_783 = ".createURI(url.toString());" + NL + "\t\t";
  protected final String TEXT_784 = " resource = new ";
  protected final String TEXT_785 = "().createResource(uri);" + NL + "\t\ttry" + NL + "\t\t{" + NL + "\t\t\tresource.load(null);" + NL + "\t\t}" + NL + "\t\tcatch (";
  protected final String TEXT_786 = " exception)" + NL + "\t\t{" + NL + "\t\t\tthrow new ";
  protected final String TEXT_787 = "(exception);" + NL + "\t\t}" + NL + "\t\tinitializeFromLoadedEPackage(this, (";
  protected final String TEXT_788 = ")resource.getContents().get(0));" + NL + "\t\tcreateResource(eNS_URI);" + NL + "\t}" + NL + "" + NL + "\t";
  ...
  protected final String TEXT_790 = NL + "\t@Override" + NL + "\t";
  protected final String TEXT_791 = NL + "\tprotected void fixInstanceClass(";
  protected final String TEXT_792 = " eClassifier)" + NL + "\t{" + NL + "\t\tif (eClassifier.getInstanceClassName() == null)" + NL + "\t\t{" + NL + "\t";
  protected final String TEXT_793 = NL + "\t";
  protected final String TEXT_794 = NL + "\t\t\teClassifier.setInstanceClassName(\"";
  protected final String TEXT_795 = ".\" + eClassifier.getName());";
  protected final String TEXT_796 = NL + "\t\t\tsetGeneratedClassName(eClassifier);" + NL + "\t";
  protected final String TEXT_797 = NL + "\t\t\tswitch (eClassifier.getClassifierID())" + NL + "\t\t\t{" + NL + "\t  ";
  protected final String TEXT_798 = NL + "\t";
  protected final String TEXT_799 = NL + "\t\t\t\tcase ";
  protected final String TEXT_800 = ":" + NL + "\t";
  protected final String TEXT_801 = NL + "\t  ";
  protected final String TEXT_802 = NL + "\t\t\t\t{" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tdefault:" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\teClassifier.setInstanceClassName(\"";
  protected final String TEXT_803 = ".\" + eClassifier.getName());";
  protected final String TEXT_804 = NL + "\t\t\t\t\tsetGeneratedClassName(eClassifier);" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t";
  protected final String TEXT_805 = NL + "\t\t}" + NL + "\t}" + NL;
  protected final String TEXT_806 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
  protected final String TEXT_807 = " addEOperation(";
  protected final String TEXT_808 = " owner, ";
  protected final String TEXT_809 = " type, String name, int lowerBound, int upperBound, boolean isUnique, boolean isOrdered)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_810 = " o = addEOperation(owner, type, name, lowerBound, upperBound);" + NL + "\t\to.setUnique(isUnique);" + NL + "\t\to.setOrdered(isOrdered);" + NL + "\t\treturn o;" + NL + "\t}" + NL + "\t";
  protected final String TEXT_811 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
  protected final String TEXT_812 = " addEParameter(";
  protected final String TEXT_813 = " owner, ";
  protected final String TEXT_814 = " type, String name, int lowerBound, int upperBound, boolean isUnique, boolean isOrdered)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_815 = " p = ecoreFactory.createEParameter();" + NL + "\t\tp.setEType(type);" + NL + "\t\tp.setName(name);" + NL + "\t\tp.setLowerBound(lowerBound);" + NL + "\t\tp.setUpperBound(upperBound);" + NL + "\t\tp.setUnique(isUnique);" + NL + "\t\tp.setOrdered(isOrdered);" + NL + "\t\towner.getEParameters().add(p);" + NL + "\t\treturn p;" + NL + "\t}" + NL + "\t";
  protected final String TEXT_816 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * Defines literals for the meta objects that represent" + NL + "\t * <ul>" + NL + "\t *   <li>each class,</li>" + NL + "\t *   <li>each feature of each class,</li>";
  protected final String TEXT_817 = NL + "\t *   <li>each operation of each class,</li>";
  protected final String TEXT_818 = NL + "\t *   <li>each enum,</li>" + NL + "\t *   <li>and each data type</li>" + NL + "\t * </ul>" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\t";
  protected final String TEXT_819 = "public ";
  protected final String TEXT_820 = "interface Literals" + NL + "\t{";
  protected final String TEXT_821 = NL + "\t\t/**" + NL + "\t";
  protected final String TEXT_822 = NL + "\t  ";
  protected final String TEXT_823 = NL + "\t\t * The meta object literal for the '{@link ";
  protected final String TEXT_824 = " <em>";
  protected final String TEXT_825 = "</em>}' class." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @see ";
  protected final String TEXT_826 = NL + "\t  ";
  protected final String TEXT_827 = NL + "\t\t * The meta object literal for the '{@link ";
  protected final String TEXT_828 = " <em>";
  protected final String TEXT_829 = "</em>}' class." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @see ";
  protected final String TEXT_830 = NL + "\t  ";
  protected final String TEXT_831 = NL + "\t";
  protected final String TEXT_832 = NL + "\t\t * The meta object literal for the '{@link ";
  protected final String TEXT_833 = " <em>";
  protected final String TEXT_834 = "</em>}' enum." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @see ";
  protected final String TEXT_835 = NL + "\t";
  protected final String TEXT_836 = NL + "\t\t * The meta object literal for the '<em>";
  protected final String TEXT_837 = "</em>' data type." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t  ";
  ...
  protected final String TEXT_843 = "()" + NL + "\t\t * @generated" + NL + "\t\t */" + NL + "\t\t";
  protected final String TEXT_844 = " ";
  protected final String TEXT_845 = " = eINSTANCE.get";
  protected final String TEXT_846 = "();" + NL + "" + NL + "\t";
  protected final String TEXT_847 = NL + "\t  ";
  protected final String TEXT_848 = NL + "\t\t/**" + NL + "\t\t * The meta object literal for the '<em><b>";
  protected final String TEXT_849 = "</b></em>' ";
  protected final String TEXT_850 = " feature." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL + "\t\t */" + NL + "\t\t";
  ...
  protected final String TEXT_858 = NL + "\t\t/**" + NL + "\t\t * The meta object literal for the '<em><b>";
  protected final String TEXT_859 = "</b></em>' operation." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL + "\t\t */" + NL + "\t\t";
  protected final String TEXT_860 = " ";
  protected final String TEXT_861 = "<";
  protected final String TEXT_862 = ", ";
  protected final String TEXT_863 = " = eINSTANCE.get";
