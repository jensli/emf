...
public class FactoryClass
{
  ...
  protected final String TEXT_47 = NL + "\tpublic <T> T create(EClass<T> eClass)" + NL + "\t{" + NL + "\t\tswitch (eClass.getClassifierID())" + NL + "\t\t{";
  ...
  protected final String TEXT_57 = NL + "\tpublic <T> T createFromString(";
