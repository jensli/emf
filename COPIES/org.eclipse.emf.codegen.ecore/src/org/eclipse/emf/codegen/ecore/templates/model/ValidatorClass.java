...
public class ValidatorClass
{
  ...
  protected final String TEXT_428 = NL + "\t\tint scale = ";
  protected final String TEXT_429 = ".scale();" + NL + "\t\tint totalDigits = scale < 0 ? ";
  protected final String TEXT_430 = ".precision() - scale : ";
  protected final String TEXT_431 = ".precision();" + NL + "\t\tboolean ";
  protected final String TEXT_432 = " = totalDigits <= ";
  ...
  protected final String TEXT_538 = " != null)" + NL + "\t\t\t{" + NL + "\t\t\t\t";
  protected final String TEXT_539 = ".add";
  protected final String TEXT_540 = NL + "\t\t\t\t\t(createDiagnostic" + NL + "\t\t\t\t\t\t(";
  protected final String TEXT_541 = ".ERROR," + NL + "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL + "\t\t\t\t\t\t \"_UI_GenericConstraint_diagnostic\",";
  ...
  protected final String TEXT_547 = " }," + NL + "\t\t\t\t\t\t context));";
  protected final String TEXT_548 = NL + "\t\t\t\t\t(new ";
  protected final String TEXT_549 = NL + "\t\t\t\t\t\t(";
  protected final String TEXT_550 = ".ERROR," + NL + "\t\t\t\t\t\t DIAGNOSTIC_SOURCE," + NL + "\t\t\t\t\t\t 0," + NL + "\t\t\t\t\t\t ";
  protected final String TEXT_551 = ".INSTANCE.getString(\"_UI_GenericConstraint_diagnostic\", new Object[] { \"";
  protected final String TEXT_552 = "\", getObjectLabel(";
  protected final String TEXT_553 = ", ";
  protected final String TEXT_554 = ") }),";
  protected final String TEXT_555 = NL + "\t\t\t\t\t\t new Object[] { ";
  protected final String TEXT_556 = " }));";
  protected final String TEXT_557 = NL + "\t\t\t}" + NL + "\t\t\treturn false;" + NL + "\t\t}" + NL + "\t\treturn ";
  protected final String TEXT_558 = "validate";
  protected final String TEXT_559 = "_";
