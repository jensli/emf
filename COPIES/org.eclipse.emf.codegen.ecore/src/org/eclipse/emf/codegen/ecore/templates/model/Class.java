...
public class Class
{
  ...
  protected final String TEXT_1847 = ")container.eGet(eContainmentFeature());" + NL + "\t}" + NL + "\t" + NL + "\t" + NL + "//\t";
  protected final String TEXT_1848 = NL + "//\t/**" + NL + "//\t * <!-- begin-user-doc -->" + NL + "//\t * <!-- end-user-doc -->" + NL + "//\t * @generated" + NL + "//\t */" + NL + "//\tEClass<";
  protected final String TEXT_1849 = "> eClass();" + NL + "//\t";
  protected final String TEXT_1850 = " " + NL + "//\t/**" + NL + "//\t * <!-- begin-user-doc -->" + NL + "//\t * <!-- end-user-doc -->" + NL + "//\t * @generated" + NL + "//\t */" + NL + "//  ";
  protected final String TEXT_1851 = NL + "//\t@Override" + NL + "//  ";
  protected final String TEXT_1852 = NL + "//\tEClass<";
  protected final String TEXT_1853 = "> eClass() {" + NL + "//\t\t@SuppressWarnings(\"unchecked\") EClass<T> cls = (EClass<";
  protected final String TEXT_1854 = ">) eClass();" + NL + "//\t\treturn cls;\t" + NL + "//\t}" + NL + "//\t";
  protected final String TEXT_1855 = " " + NL + "\t" + NL;
...
if (index != -1) { head = typeName.substring(0, index); tail = "<code>" + CodeGenUtil.xmlEscapeEncode(typeName.substring(index)) + "</code>"; }
    ...
    if (isInterface && genModel.useGenerics()) {
    stringBuffer.append(TEXT_1848);
    stringBuffer.append(genClass.getClassName());
    stringBuffer.append(TEXT_1849);
    } else if (isImplementation && genModel.useGenerics()) {
