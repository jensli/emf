...
public interface EClass<T extends EObject> extends EClassifier<T>
{
   ...
   * @generated
   */
  EList<EAttribute<T, ?>> getEAllAttributes();
   ...
   * @generated
   */
  EList<EReference<T, ?>> getEAllReferences();
   ...
   * @generated
   */
  EList<EReference<T, ?>> getEAllContainments();
   ...
   * @generated
   */
  EList<EStructuralFeature<T, ?>> getEAllStructuralFeatures();
   ...
   * @generated
   */
  EList<EOperation<T, ?>> getEAllOperations();
