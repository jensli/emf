 ...
 * @generated
 */
public interface EClass<T extends EObject> extends EClassifier<T>
{
  /**
  ...
  /**
	 ...
	 * The list contents are of type {@link org.eclipse.emf.ecore.EClass}<code>&lt;?&gt;</code>.
	 * <!-- begin-user-doc -->
   * <p>
  ...
  /**
	 ...
	 * The list contents are of type {@link org.eclipse.emf.ecore.EStructuralFeature}<code>&lt;T, ?&gt;</code>.
   ...
   * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
  EList<EStructuralFeature<T, ?>> getEStructuralFeatures();
  ...
  /**
	 ...
	 * The list contents are of type {@link org.eclipse.emf.ecore.EAttribute}<code>&lt;T, ?&gt;</code>.
	 * <!-- begin-user-doc -->
   * <p>
   ...
   * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
  EList<EAttribute<T, ?>> getEAttributes();
  ...
  /**
	 ...
	 * The list contents are of type {@link org.eclipse.emf.ecore.EReference}<code>&lt;T, ?&gt;</code>.
	 * <!-- begin-user-doc -->
   * <p>
   ...
   * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
  EList<EReference<T, ?>> getEReferences();

  /**
	 * Returns the value of the '<em><b>EAll References</b></em>' reference list.
	 * The list contents are of type {@link org.eclipse.emf.ecore.EReference}<code>&lt;?, ?&gt;</code>.
	 * <!-- begin-user-doc -->
   * <p>
  ...
  /**
	 ...
	 * The list contents are of type {@link org.eclipse.emf.ecore.EStructuralFeature}<code>&lt;?, ?&gt;</code>.
	 * <!-- begin-user-doc -->
   * <p>
  ...
  /**
	 ...
	 * The list contents are of type {@link org.eclipse.emf.ecore.EOperation}<code>&lt;T, ?&gt;</code>.
   ...
   * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
  EList<EOperation<T, ?>> getEOperations();

  /**
	 * Returns the value of the '<em><b>EAll Operations</b></em>' reference list.
	 * The list contents are of type {@link org.eclipse.emf.ecore.EOperation}<code>&lt;?, ?&gt;</code>.
	 * <!-- begin-user-doc -->
   * <p>
   ...
   * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
  EStructuralFeature<T, ?> getEStructuralFeature(int featureID);
   ...
   * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
  EStructuralFeature<T, ?> getEStructuralFeature(String featureName);
   ...
   * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
  int getOperationID(EOperation<? super T, ?> operation);
