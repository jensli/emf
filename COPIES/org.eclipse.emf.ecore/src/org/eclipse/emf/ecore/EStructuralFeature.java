 ...
 * @generated
 */
public interface EStructuralFeature<C extends EObject, V> extends ETypedElement<V>
{
  /**
   ...
   */
  interface Setting<C extends EObject, V>
  {
    /**
     ...
     */
    EStructuralFeature<C, V> getEStructuralFeature();
   ...
   */
  interface Internal<C extends InternalEObject, V> extends EStructuralFeature<C, V>, InternalEObject
  {
    /**
     ...
     */
    interface SettingDelegate<C extends InternalEObject, V>
    {
      /**
      ...
      interface Factory
      {
         ...
         */
    	 <V> SettingDelegate<?, V> createSettingDelegate(EStructuralFeature<?, V> eStructuralFeature);
       ...
       */
      Setting<C, V> dynamicSetting(InternalEObject owner, DynamicValueHolder settings, int dynamicFeatureID);
       ...
       * @see EObject#eGet(EStructuralFeature, boolean)
       */
      V dynamicGet(InternalEObject owner, DynamicValueHolder settings, int dynamicFeatureID, boolean resolve, boolean coreType);
       ...
       * @see EObject#eSet(EStructuralFeature, Object)
       */
      void dynamicSet(InternalEObject owner, DynamicValueHolder settings, int dynamicFeatureID, V newValue);
      ...
      NotificationChain dynamicInverseAdd
        (InternalEObject owner, DynamicValueHolder settings, int dynamicFeatureID, C otherEnd, NotificationChain notifications);
     ...
     */
    SettingDelegate<C, V> getSettingDelegate();

    /**
     * Sets the specialized delegate for this feature.
     * @param settingDelegate the specialized delegate.
     */
    void setSettingDelegate(SettingDelegate<C, V> settingDelegate);
     ...
     */
    public EReference<? extends V, C> getEOpposite();
  }
}
