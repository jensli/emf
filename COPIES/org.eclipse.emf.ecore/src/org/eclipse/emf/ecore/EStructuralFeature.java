...
public interface EStructuralFeature<C extends EObject, V> extends ETypedElement<V>
{
   ...
   */
  interface Internal<C extends EObject, V> extends EStructuralFeature<C, V>, InternalEObject
  {
    /**
     ...
     */
    interface SettingDelegate<C extends EObject, V>
    {
      /**
      ...
      interface Factory
      {
         ...
         */
     <C extends EObject, V> SettingDelegate<C, V> createSettingDelegate(EStructuralFeature<C, V> eStructuralFeature);
