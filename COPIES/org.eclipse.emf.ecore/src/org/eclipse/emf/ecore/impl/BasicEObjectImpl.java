...
public class BasicEObjectImpl extends BasicNotifierImpl implements EObject, InternalEObject
{
   ...
   */
  protected static class EPropertiesHolderImpl<C extends EObject> extends EPropertiesHolderBaseImpl<C>
  {
  ...
  private static <T> void eEncodeValue(StringBuilder result, EFactory eFactory, EDataType<T> eDataType, T value)
  {
  ...
  public <V> V eGet(EStructuralFeature<?, V> eFeature, boolean resolve)
  {
  ...
  public <V> V eGet(EStructuralFeature<?, V> eFeature, boolean resolve, boolean coreType)
  {
    ...
    if (featureID >= 0)
    {
      return (V) eGet(featureID, resolve, coreType);
    }
    else
    {
  ...
  {
    @SuppressWarnings("unchecked")
	EStructuralFeature<InternalEObject, ?> eFeature = (EStructuralFeature<InternalEObject, ?>) eClass().getEStructuralFeature(featureID);
  ...
  public <V> V eDynamicGet(EStructuralFeature<?, V> eFeature, boolean resolve)
  {
    @SuppressWarnings("unchecked")
	V ret = (V) eDynamicGet(eDynamicFeatureID(eFeature), eFeature, resolve, true);
	return ret;
  }
  ...
  protected <V> Object eDynamicGet(int dynamicFeatureID, EStructuralFeature<?, V> eFeature, boolean resolve, boolean coreType)
  {
    return
      dynamicFeatureID < 0 ?
  ...
  public <V> void eSet(EStructuralFeature<?, V> eFeature, V newValue) 
  {
    int featureID = eDerivedStructuralFeatureID(eFeature);
    if (featureID >= 0)
    {
  ...
  public int eDerivedStructuralFeatureID(EStructuralFeature<?, ?> eStructuralFeature)
  {
    ...
    {
      return eClass().getFeatureID((EStructuralFeature) eStructuralFeature);
    }
    else
    {
  ...
  public int eDerivedOperationID(EOperation<?, ?> eOperation)
  {
    ...
    if (containerClass == null)
    {
      ...
      EOperation<?, ?> override = eClass.getOverride((EOperation) eOperation);
      return eClass.getOperationID((EOperation) (override != null ? override : eOperation));
    }
    else
    {
  ...
  protected EClass<? extends EObject> eStaticClass()
  {
    return EcorePackage.eINSTANCE.getEObject();
  }

  protected EClass<? extends EObject> eDynamicClass()
  {
    return 
  ...
  public <V> EStructuralFeature.Setting<?, V> eSetting(final EStructuralFeature<?, V> eFeature)
  {
    ...
    EStructuralFeature.Setting<?, V> setting =
      new EStructuralFeature.Setting<EObject, V>()
      {
  ...
  public <T> T eInvoke(EOperation<?, T> eOperation, EList<?> arguments) throws InvocationTargetException
  {
    int operationID = eDerivedOperationID(eOperation);
    if (operationID >= 0)
    {
      @SuppressWarnings("unchecked")
      T ret = (T) eInvoke(operationID, arguments);
      return ret;
    }
    else
    {
