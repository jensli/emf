 ...
 * @generated
 */
public abstract class ETypedElementImpl<C> extends ENamedElementImpl implements ETypedElement<C>
{
  /**
...
public EClassifier<C> getEType()
   ...
   * @generated NOT
   */
  public EClassifier<C> basicGetEType()
  {
    return eType;
  }

  public NotificationChain setEType(EClassifier<C> newEType, NotificationChain msgs)
  {
    EClassifier<C> oldEType = eType;
    eType = newEType;
    if (eNotificationRequired())
    {
  ...
  public void setEType(EClassifier<C> newEType)
  {
  ...
  public NotificationChain basicSetEGenericType(EGenericType newEGenericType, NotificationChain msgs)
  {
    ...
    {
      @SuppressWarnings("unchecked")
      EClassifier<C> newEType = (EClassifier<C>) ((EGenericTypeImpl)newEGenericType).basicGetERawType();
      if (newEType != eType)
      {
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case EcorePackage.ETYPED_ELEMENT__UPPER_BOUND:
        ...
        return;
      case EcorePackage.ETYPED_ELEMENT__ETYPE:
        setEType((EClassifier<C>)newValue);
        return;
      case EcorePackage.ETYPED_ELEMENT__EGENERIC_TYPE:
