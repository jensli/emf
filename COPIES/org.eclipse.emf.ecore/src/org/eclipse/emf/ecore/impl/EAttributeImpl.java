 ...
 * @generated
 */
public class EAttributeImpl<C extends EObject, V> extends EStructuralFeatureImpl<C, V> implements EAttribute<C, V>
{
  /**
  ...
  @Override
  public NotificationChain setEType(EClassifier<V> newEType, NotificationChain msgs)
  {
    effectiveIsMany = 0;
    eAttributeType = null;
  ...
  protected EDataType<V> eAttributeType;
   ...
   * @generated NOT
   */
  public EDataType<V> getEAttributeType()
  {
    if (eAttributeType == null || !isFrozen() && eAttributeType.eIsProxy())
    {
      ...
      {
        eAttributeType = (EDataType<V>)eType;
      }
    }
   ...
   * @generated NOT
   */
  public EDataType<V> basicGetEAttributeType()
  {
    if (eAttributeType == null)
    {
      EClassifier<V> eType = basicGetEType();
      if (eType instanceof EDataType)
      {
        eAttributeType = (EDataType<V>)eType;
      }
