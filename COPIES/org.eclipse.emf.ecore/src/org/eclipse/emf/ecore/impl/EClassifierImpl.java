 ...
 * @generated
 */
public abstract class EClassifierImpl<T> extends ENamedElementImpl implements EClassifier<T>, BasicExtendedMetaData.EClassifierExtendedMetaData.Holder
{
   ...
   * @see #getInstanceClass()
   */
  protected Class<T> instanceClass = (Class<T>) INSTANCE_CLASS_EDEFAULT;

  public Class<T> getInstanceClass() 
  {
    if (instanceClass == null && (instanceClassName != null || generatedInstanceClassName != null))
    {
      Class<T> primitiveClass = getPrimitiveOrArrayClass();
   ...
   * that Ecore's can't.
   */
  protected Class<T> getClassForName(String name) throws ClassNotFoundException
  {
    EPackage p = getEPackage();
    return (Class<T>) (p != null ? Class.forName(name, true, p.getClass().getClassLoader()) : Class.forName(name));
  }
  
  protected Class<T> getPrimitiveOrArrayClass() 
  {
    ...
    if (arrayIndex != -1)
    {
      ...
      try
      {
        return (Class<T>) getClassForName(result.toString());
      }
      catch (ClassNotFoundException e) 
      {
    ...
    else if (className.indexOf('.') == -1)
    {
      if (className.equals("boolean"))
        return (Class<T>) java.lang.Boolean.TYPE;
      else if (className.equals("byte"))
        return (Class<T>) java.lang.Byte.TYPE;
      else if (className.equals("char"))
        return (Class<T>) java.lang.Character.TYPE;
      else if (className.equals("double"))
        return (Class<T>) java.lang.Double.TYPE;
      else if (className.equals("float"))
        return (Class<T>) java.lang.Float.TYPE;
      else if (className.equals("int"))
        return (Class<T>) java.lang.Integer.TYPE;
      else if (className.equals("long"))
        return (Class<T>) java.lang.Long.TYPE;
      else if (className.equals("short"))
        return (Class<T>) java.lang.Short.TYPE;
    }
    return null;
  }
  ...
  /**
   */
  public Class<T> getInstanceClassGen()
  {
    return instanceClass;
  }

  public void setInstanceClass(Class<T> value)
  {
    if (value == null)
    {
  ...
  /**
   */
  public void setInstanceClassGen(Class<T> newInstanceClass)
  {
