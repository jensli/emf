...
public class EcoreValidator extends EObjectValidator
{
  ...
  {
    boolean result = true;
    EList<? extends EOperation<?, ?>> eAllOperations = eClass.getEAllOperations();
    if (!eAllOperations.isEmpty())
    {
      // Iterate over all the operations but skip all the operations in the first super.
      //
      List<? extends EOperation<?, ?>> eOperations = eAllOperations;
              ...
              if (name.equals(otherName))
              {
                ...
                if (otherEParmeters.size() == eParameterSize)
                {
                  ...
                  else
                  {
                    ...
                    {
                      EList<? extends EOperation<?, ?>> superTypeEAllOperations = eSuperType.getEAllOperations();
  ...
  {
    boolean result = true;
    EList<EOperation<?, ?>> eOperations = (EList<EOperation<?, ?>>) (Object) eClass.getEOperations();
    ...
    if (!eOperations.isEmpty())
    {
      for (EStructuralFeature<?, ?> eStructuralFeature : eClass.getEStructuralFeatures())
      {
        ...
        EClassifier<EObject> eType = (EClassifier<EObject>) eStructuralFeature.getEType();
        if (featureName != null && featureName.length() != 0 && eType != null)
        {
          ...
          if (!eStructuralFeature.isMany() && eStructuralFeature.isChangeable() && !EcoreUtil.isSuppressedVisibility(eStructuralFeature, EcoreUtil.SET))
          {
            ...
            EParameter<EObject> eParameter = EcoreFactory.eINSTANCE.createEParameter();
