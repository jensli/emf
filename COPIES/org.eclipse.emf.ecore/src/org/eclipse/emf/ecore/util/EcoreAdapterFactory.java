...
public class EcoreAdapterFactory extends AdapterFactoryImpl
{
  ...
  protected EcoreSwitch<Adapter> modelSwitch =
    ...
    {
      @Override
      public <C extends EObject, V> Adapter caseEAttribute(EAttribute<C, V> object)
      {
      ...
      @Override
      public <T extends EObject> Adapter caseEClass(EClass<T> object)
      {
        return createEClassAdapter();
      }
      @Override
      public <T> Adapter caseEClassifier(EClassifier<T> object)
      {
        return createEClassifierAdapter();
      }
      @Override
      public <T> Adapter caseEDataType(EDataType<T> object)
      {
        return createEDataTypeAdapter();
      }
      @Override
      public <T> Adapter caseEEnum(EEnum<T> object)
      {
      ...
      @Override
      public <C extends EObject, V> Adapter caseEOperation(EOperation<C, V> object)
      {
      ...
      @Override
      public <T> Adapter caseEParameter(EParameter<T> object)
      {
        return createEParameterAdapter();
      }
      @Override
      public <C extends EObject, V> Adapter caseEReference(EReference<C, V> object)
      {
        return createEReferenceAdapter();
      }
      @Override
      public <C extends EObject, V> Adapter caseEStructuralFeature(EStructuralFeature<C, V> object)
      {
        return createEStructuralFeatureAdapter();
      }
      @Override
      public <C> Adapter caseETypedElement(ETypedElement<C> object)
      {
