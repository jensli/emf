...
public class FactoryClass
{
  ...
  protected final String TEXT_47 = NL + "\t// CHANGE: Added generics and annotation" + NL + "\t@SuppressWarnings(\"unchecked\")" + NL + "\tpublic <T extends EObject> T create(EClass<T> eClass)" + NL + "\t{" + NL + "\t\tswitch (eClass.getClassifierID())" + NL + "\t\t{";
  ...
  protected final String TEXT_57 = NL + "\t// CHANGE: Added generics and annotation" + NL + "\t@SuppressWarnings(\"unchecked\")" + NL + "\tpublic <T> T createFromString(";
  protected final String TEXT_58 = "<T> eDataType, String initialValue)" + NL + "\t{" + NL + "\t\tswitch (eDataType.getClassifierID())" + NL + "\t\t{";
  ...
  protected final String TEXT_66 = NL + "\tpublic <T> String convertToString(";
  protected final String TEXT_67 = "<T> eDataType, T instanceValue)" + NL + "\t{" + NL + "\t\tswitch (eDataType.getClassifierID())" + NL + "\t\t{";
