...
public class PackageClass
{
  ...
  protected final String TEXT_230 = NL + "\t// CHANGE gen: Class accessor" + NL + "\t";
  ...
  protected final String TEXT_255 = "().getEStructuralFeatures().get(";
  protected final String TEXT_256 = ");";
  protected final String TEXT_257 = NL + "\t}";
  protected final String TEXT_258 = NL + "\t// CHANGE gen: Feature accessor" + NL + "\t";
  protected final String TEXT_259 = " get";
  protected final String TEXT_260 = "();";
  protected final String TEXT_261 = NL;
  protected final String TEXT_262 = NL + "\t/**" + NL + "\t * Returns the meta object for the '{@link ";
  protected final String TEXT_263 = "#";
  protected final String TEXT_264 = "(";
  protected final String TEXT_265 = ") <em>";
  protected final String TEXT_266 = "</em>}' operation." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the meta object for the '<em>";
  protected final String TEXT_267 = "</em>' operation." + NL + "\t * @see ";
  protected final String TEXT_268 = "#";
  protected final String TEXT_269 = "(";
  protected final String TEXT_270 = ")" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_271 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_272 = NL + "// CHANGE gen: Operation accessor";
  ...
  protected final String TEXT_279 = ".getEOperations().get(";
  protected final String TEXT_280 = ");";
  protected final String TEXT_281 = NL + "        return (";
  protected final String TEXT_282 = ") get";
  protected final String TEXT_283 = "().getEOperations().get(";
  ...
  protected final String TEXT_290 = NL + "\t/**" + NL + "\t * Returns the factory that creates the instances of the model." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the factory that creates the instances of the model." + NL + "\t * @generated" + NL + "\t */";
  ...
  protected final String TEXT_295 = ")getEFactoryInstance();" + NL + "\t}";
  protected final String TEXT_296 = NL + "\t";
  protected final String TEXT_297 = " get";
  protected final String TEXT_298 = "();";
  protected final String TEXT_299 = NL;
  protected final String TEXT_300 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isCreated = false;" + NL + "" + NL + "\t/**" + NL + "\t * Creates the meta-model objects for the package.  This method is" + NL + "\t * guarded to have no affect on any invocation but its first." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_301 = NL + "\t@SuppressWarnings(\"unchecked\")";
  protected final String TEXT_302 = " " + NL + "\tpublic void createPackageContents()" + NL + "\t{" + NL + "\t\tif (isCreated) return;" + NL + "\t\tisCreated = true;";
  protected final String TEXT_303 = NL + NL + "\t\t// Create classes and their features";
  protected final String TEXT_304 = NL + "\t\t// CHANGE gen: Add cast" + NL + "\t\t";
  protected final String TEXT_305 = " = (";
  protected final String TEXT_306 = ") create";
  protected final String TEXT_307 = "(";
  protected final String TEXT_308 = ");";
  protected final String TEXT_309 = NL + "\t\t// CHANGE gen: Use raw type" + NL + "\t\tcreate";
  protected final String TEXT_310 = "(";
  protected final String TEXT_311 = ", ";
  protected final String TEXT_312 = ");";
  protected final String TEXT_313 = NL + "\t\tcreateEOperation(";
  protected final String TEXT_314 = ", ";
  protected final String TEXT_315 = ");";
  protected final String TEXT_316 = NL;
  protected final String TEXT_317 = NL + NL + "\t\t// Create enums";
  protected final String TEXT_318 = NL + " \t\t// CHANGE gen: Cast" + NL + "\t\t";
  protected final String TEXT_319 = " = (";
  protected final String TEXT_320 = ") createEEnum(";
  protected final String TEXT_321 = ");";
  protected final String TEXT_322 = NL + NL + "\t\t// Create data types";
  protected final String TEXT_323 = NL + "\t\t// CHANGE gen: Cast" + NL + "\t\t";
  protected final String TEXT_324 = " = (";
  protected final String TEXT_325 = ") createEDataType(";
  protected final String TEXT_326 = ");";
  protected final String TEXT_327 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isInitialized = false;" + NL;
  protected final String TEXT_328 = NL + "\t/**" + NL + "\t * Complete the initialization of the package and its meta-model.  This" + NL + "\t * method is guarded to have no affect on any invocation but its first." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void initializePackageContents()" + NL + "\t{" + NL + "\t\tif (isInitialized) return;" + NL + "\t\tisInitialized = true;" + NL + "" + NL + "\t\t// Initialize package" + NL + "\t\tsetName(eNAME);" + NL + "\t\tsetNsPrefix(eNS_PREFIX);" + NL + "\t\tsetNsURI(eNS_URI);";
  protected final String TEXT_329 = NL + NL + "\t\t// Obtain other dependent packages";
  protected final String TEXT_330 = NL + "\t\t";
  protected final String TEXT_331 = " ";
  protected final String TEXT_332 = " = (";
  protected final String TEXT_333 = ")";
  protected final String TEXT_334 = ".Registry.INSTANCE.getEPackage(";
  protected final String TEXT_335 = ".eNS_URI);";
  protected final String TEXT_336 = NL + NL + "\t\t// Add subpackages";
  protected final String TEXT_337 = NL + "\t\tgetESubpackages().add(";
  protected final String TEXT_338 = ");";
  protected final String TEXT_339 = NL + NL + "\t\t// Create type parameters";
  protected final String TEXT_340 = NL + "\t\t";
  protected final String TEXT_341 = " ";
  protected final String TEXT_342 = "_";
  protected final String TEXT_343 = " = addETypeParameter(";
  protected final String TEXT_344 = ", \"";
  protected final String TEXT_345 = "\");";
  protected final String TEXT_346 = NL + "\t\taddETypeParameter(";
  protected final String TEXT_347 = ", \"";
  protected final String TEXT_348 = "\");";
  protected final String TEXT_349 = NL + NL + "\t\t// Set bounds for type parameters";
  protected final String TEXT_350 = NL + "\t\t";
  protected final String TEXT_351 = "g";
  protected final String TEXT_352 = " = createEGenericType(";
  protected final String TEXT_353 = ");";
  protected final String TEXT_354 = NL + "\t\tg";
  protected final String TEXT_355 = ".";
  protected final String TEXT_356 = "(g";
  protected final String TEXT_357 = ");";
  protected final String TEXT_358 = NL + "\t\t";
  protected final String TEXT_359 = "_";
  protected final String TEXT_360 = ".getEBounds().add(g1);";
  protected final String TEXT_361 = NL + NL + "\t\t// Add supertypes to classes";
  protected final String TEXT_362 = NL + "\t\t";
  protected final String TEXT_363 = ".getESuperTypes().add(";
  protected final String TEXT_364 = ".get";
  protected final String TEXT_365 = "());";
  protected final String TEXT_366 = NL + "\t\t";
  protected final String TEXT_367 = "g";
  protected final String TEXT_368 = " = createEGenericType(";
  protected final String TEXT_369 = ");";
  protected final String TEXT_370 = NL + "\t\tg";
  protected final String TEXT_371 = ".";
  protected final String TEXT_372 = "(g";
  protected final String TEXT_373 = ");";
  protected final String TEXT_374 = NL + "\t\t";
  protected final String TEXT_375 = ".getEGenericSuperTypes().add(g1);";
  protected final String TEXT_376 = NL + NL + "\t\t// Initialize classes";
  protected final String TEXT_377 = ", features, and operations; add parameters";
  protected final String TEXT_378 = " and features; add operations and parameters";
  protected final String TEXT_379 = NL + "\t\tinitEClass(";
  protected final String TEXT_380 = ", ";
  protected final String TEXT_381 = "null";
  protected final String TEXT_382 = ".class";
  ...
  protected final String TEXT_398 = NL + "\t\tinitEReference(get";
  protected final String TEXT_399 = "(), ";
  protected final String TEXT_400 = "g1";
  ...
  protected final String TEXT_419 = NL + "\t\tget";
  protected final String TEXT_420 = "().getEKeys().add(";
  protected final String TEXT_421 = ".get";
  protected final String TEXT_422 = "());";
  protected final String TEXT_423 = NL + "\t\tinitEAttribute(get";
  protected final String TEXT_424 = "(), ";
  protected final String TEXT_425 = "g1";
  ...
  protected final String TEXT_444 = "initEOperation(get";
  protected final String TEXT_445 = "()";
  protected final String TEXT_446 = "addEOperation(";
  ...
  protected final String TEXT_480 = "initEOperation(get";
  protected final String TEXT_481 = "()";
  protected final String TEXT_482 = "addEOperation(";
  protected final String TEXT_483 = ", null, \"";
  protected final String TEXT_484 = "\");";
  protected final String TEXT_485 = NL + "\t\t";
  protected final String TEXT_486 = "addETypeParameter(op, \"";
  ...
  protected final String TEXT_496 = NL + "\t\tt";
  protected final String TEXT_497 = ".getEBounds().add(g1);";
  protected final String TEXT_498 = NL + "\t\t";
  protected final String TEXT_499 = "g";
  protected final String TEXT_500 = " = createEGenericType(";
  protected final String TEXT_501 = ");";
  protected final String TEXT_502 = NL + "\t\tg";
  protected final String TEXT_503 = ".";
  protected final String TEXT_504 = "(g";
  ...
  protected final String TEXT_526 = NL + "\t\taddEParameter(op, ";
  protected final String TEXT_527 = "g1";
  protected final String TEXT_528 = ".get";
  ...
  protected final String TEXT_542 = NL + "\t\taddEException(op, g";
  protected final String TEXT_543 = ");";
  protected final String TEXT_544 = NL + "\t\taddEException(op, ";
  protected final String TEXT_545 = ".get";
  protected final String TEXT_546 = "());";
  protected final String TEXT_547 = NL + "\t\t";
  protected final String TEXT_548 = "g";
  protected final String TEXT_549 = " = createEGenericType(";
  protected final String TEXT_550 = ");";
  protected final String TEXT_551 = NL + "\t\tg";
  protected final String TEXT_552 = ".";
  protected final String TEXT_553 = "(g";
  protected final String TEXT_554 = ");";
  protected final String TEXT_555 = NL + "\t\tinitEOperation(op, g1);";
  protected final String TEXT_556 = NL;
  protected final String TEXT_557 = NL + NL + "\t\t// Initialize enums and add enum literals";
  protected final String TEXT_558 = NL + "\t\tinitEEnum(";
  protected final String TEXT_559 = ", ";
  protected final String TEXT_560 = ".class, \"";
  protected final String TEXT_561 = "\");";
  protected final String TEXT_562 = NL + "\t\taddEEnumLiteral(";
  protected final String TEXT_563 = ", ";
  protected final String TEXT_564 = ".";
  protected final String TEXT_565 = ");";
  protected final String TEXT_566 = NL;
  protected final String TEXT_567 = NL + NL + "\t\t// Initialize data types";
  protected final String TEXT_568 = NL + "\t\tinitEDataType(";
  protected final String TEXT_569 = ", ";
  protected final String TEXT_570 = ".class, \"";
  protected final String TEXT_571 = "\", ";
  protected final String TEXT_572 = ", ";
  protected final String TEXT_573 = ", \"";
  protected final String TEXT_574 = "\"";
  protected final String TEXT_575 = ");";
  protected final String TEXT_576 = NL + NL + "\t\t// Create resource" + NL + "\t\tcreateResource(";
  protected final String TEXT_577 = ");";
  protected final String TEXT_578 = NL + NL + "\t\t// Create annotations";
  protected final String TEXT_579 = NL + "\t\t// ";
  protected final String TEXT_580 = NL + "\t\tcreate";
  protected final String TEXT_581 = "Annotations();";
  protected final String TEXT_582 = NL + "\t}" + NL;
  protected final String TEXT_583 = NL + "\t/**" + NL + "\t * Initializes the annotations for <b>";
  protected final String TEXT_584 = "</b>." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected void create";
  protected final String TEXT_585 = "Annotations()" + NL + "\t{" + NL + "\t\tString source = ";
  protected final String TEXT_586 = "null;";
  protected final String TEXT_587 = "\"";
  protected final String TEXT_588 = "\";";
  protected final String TEXT_589 = "\t" + NL + "\t\taddAnnotation" + NL + "\t\t  (";
  protected final String TEXT_590 = ", " + NL + "\t\t   source, " + NL + "\t\t   new String[] " + NL + "\t\t   {";
  protected final String TEXT_591 = NL + "\t\t\t ";
  protected final String TEXT_592 = ", ";
  protected final String TEXT_593 = NL + "\t\t   }";
  protected final String TEXT_594 = ");";
  protected final String TEXT_595 = ",";
  protected final String TEXT_596 = NL + "\t\t   new ";
  protected final String TEXT_597 = "[] " + NL + "\t\t   {";
  protected final String TEXT_598 = NL + "\t\t\t ";
  protected final String TEXT_599 = ".createURI(";
  protected final String TEXT_600 = ".";
  protected final String TEXT_601 = "eNS_URI).appendFragment(\"";
  protected final String TEXT_602 = "\")";
  protected final String TEXT_603 = ",";
  protected final String TEXT_604 = NL + "\t\t   });";
  protected final String TEXT_605 = NL + "\t\taddAnnotation" + NL + "\t\t  (";
  protected final String TEXT_606 = ", " + NL + "\t\t   ";
  protected final String TEXT_607 = "new boolean[] { ";
  protected final String TEXT_608 = " }";
  protected final String TEXT_609 = "," + NL + "\t\t   ";
  protected final String TEXT_610 = "null,";
  protected final String TEXT_611 = "\"";
  protected final String TEXT_612 = "\",";
  protected final String TEXT_613 = NL + "\t\t   new String[] " + NL + "\t\t   {";
  protected final String TEXT_614 = NL + "\t\t\t ";
  protected final String TEXT_615 = ", ";
  protected final String TEXT_616 = NL + "\t\t   }";
  protected final String TEXT_617 = ");";
  protected final String TEXT_618 = ",";
  protected final String TEXT_619 = NL + "\t\t   new ";
  protected final String TEXT_620 = "[] " + NL + "\t\t   {";
  protected final String TEXT_621 = NL + "\t\t\t ";
  protected final String TEXT_622 = ".createURI(";
  protected final String TEXT_623 = ".";
  protected final String TEXT_624 = "eNS_URI).appendFragment(\"";
  protected final String TEXT_625 = "\")";
  protected final String TEXT_626 = ",";
  protected final String TEXT_627 = NL + "\t\t   });";
  protected final String TEXT_628 = NL + "\t}" + NL;
  protected final String TEXT_629 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isLoaded = false;" + NL + "" + NL + "\t/**" + NL + "\t * Laods the package and any sub-packages from their serialized form." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void loadPackage()" + NL + "\t{" + NL + "\t\tif (isLoaded) return;" + NL + "\t\tisLoaded = true;" + NL + "" + NL + "\t\t";
  protected final String TEXT_630 = " url = getClass().getResource(packageFilename);" + NL + "\t\tif (url == null)" + NL + "\t\t{" + NL + "\t\t\tthrow new RuntimeException(\"Missing serialized package: \" + packageFilename);";
  protected final String TEXT_631 = NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_632 = " uri = ";
  protected final String TEXT_633 = ".createURI(url.toString());" + NL + "\t\t";
  protected final String TEXT_634 = " resource = new ";
  protected final String TEXT_635 = "().createResource(uri);" + NL + "\t\ttry" + NL + "\t\t{" + NL + "\t\t\tresource.load(null);" + NL + "\t\t}" + NL + "\t\tcatch (";
  protected final String TEXT_636 = " exception)" + NL + "\t\t{" + NL + "\t\t\tthrow new ";
  protected final String TEXT_637 = "(exception);" + NL + "\t\t}" + NL + "\t\tinitializeFromLoadedEPackage(this, (";
  protected final String TEXT_638 = ")resource.getContents().get(0));" + NL + "\t\tcreateResource(eNS_URI);" + NL + "\t}" + NL;
  protected final String TEXT_639 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isFixed = false;" + NL + "" + NL + "\t/**" + NL + "\t * Fixes up the loaded package, to make it appear as if it had been programmatically built." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void fixPackageContents()" + NL + "\t{" + NL + "\t\tif (isFixed) return;" + NL + "\t\tisFixed = true;" + NL + "\t\tfixEClassifiers();" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * Sets the instance class on the given classifier." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */";
  protected final String TEXT_640 = NL + "\t@Override";
  protected final String TEXT_641 = NL + "\tprotected void fixInstanceClass(";
  protected final String TEXT_642 = " eClassifier)" + NL + "\t{" + NL + "\t\tif (eClassifier.getInstanceClassName() == null)" + NL + "\t\t{";
  protected final String TEXT_643 = NL + "\t\t\teClassifier.setInstanceClassName(\"";
  protected final String TEXT_644 = ".\" + eClassifier.getName());";
  protected final String TEXT_645 = NL + "\t\t\tsetGeneratedClassName(eClassifier);";
  protected final String TEXT_646 = NL + "\t\t\tswitch (eClassifier.getClassifierID())" + NL + "\t\t\t{";
  protected final String TEXT_647 = NL + "\t\t\t\tcase ";
  protected final String TEXT_648 = ":";
  protected final String TEXT_649 = NL + "\t\t\t\t{" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tdefault:" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\teClassifier.setInstanceClassName(\"";
  protected final String TEXT_650 = ".\" + eClassifier.getName());";
  protected final String TEXT_651 = NL + "\t\t\t\t\tsetGeneratedClassName(eClassifier);" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t}";
  protected final String TEXT_652 = NL + "\t\t}" + NL + "\t}" + NL;
  protected final String TEXT_653 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
  protected final String TEXT_654 = " addEOperation(";
  protected final String TEXT_655 = " owner, ";
  protected final String TEXT_656 = " type, String name, int lowerBound, int upperBound, boolean isUnique, boolean isOrdered)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_657 = " o = addEOperation(owner, type, name, lowerBound, upperBound);" + NL + "\t\to.setUnique(isUnique);" + NL + "\t\to.setOrdered(isOrdered);" + NL + "\t\treturn o;" + NL + "\t}" + NL + "\t";
  protected final String TEXT_658 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
  protected final String TEXT_659 = " addEParameter(";
  protected final String TEXT_660 = " owner, ";
  protected final String TEXT_661 = " type, String name, int lowerBound, int upperBound, boolean isUnique, boolean isOrdered)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_662 = " p = ecoreFactory.createEParameter();" + NL + "\t\tp.setEType(type);" + NL + "\t\tp.setName(name);" + NL + "\t\tp.setLowerBound(lowerBound);" + NL + "\t\tp.setUpperBound(upperBound);" + NL + "\t\tp.setUnique(isUnique);" + NL + "\t\tp.setOrdered(isOrdered);" + NL + "\t\towner.getEParameters().add(p);" + NL + "\t\treturn p;" + NL + "\t}" + NL + "\t";
  protected final String TEXT_663 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * Defines literals for the meta objects that represent" + NL + "\t * <ul>" + NL + "\t *   <li>each class,</li>" + NL + "\t *   <li>each feature of each class,</li>";
  protected final String TEXT_664 = NL + "\t *   <li>each operation of each class,</li>";
  protected final String TEXT_665 = NL + "\t *   <li>each enum,</li>" + NL + "\t *   <li>and each data type</li>" + NL + "\t * </ul>" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\t";
  protected final String TEXT_666 = "public ";
  protected final String TEXT_667 = "interface Literals" + NL + "\t{";
  protected final String TEXT_668 = NL + "\t\t/**";
  protected final String TEXT_669 = NL + "\t\t * The meta object literal for the '{@link ";
  protected final String TEXT_670 = " <em>";
  protected final String TEXT_671 = "</em>}' class." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @see ";
  protected final String TEXT_672 = NL + "\t\t * The meta object literal for the '{@link ";
  protected final String TEXT_673 = " <em>";
  protected final String TEXT_674 = "</em>}' class." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @see ";
  protected final String TEXT_675 = NL + "\t\t * The meta object literal for the '{@link ";
  protected final String TEXT_676 = " <em>";
  protected final String TEXT_677 = "</em>}' enum." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @see ";
  protected final String TEXT_678 = NL + "\t\t * The meta object literal for the '<em>";
  protected final String TEXT_679 = "</em>' data type." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->";
  protected final String TEXT_680 = NL + "\t\t * @see ";
  protected final String TEXT_681 = NL + "\t\t * @see ";
  protected final String TEXT_682 = "#get";
  protected final String TEXT_683 = "()" + NL + "\t\t * @generated" + NL + "\t\t */" + NL + "\t\t// CHANGE gen: Classifier literal" + NL + "\t\t";
  protected final String TEXT_684 = " ";
  protected final String TEXT_685 = " = eINSTANCE.get";
  protected final String TEXT_686 = "();" + NL;
  protected final String TEXT_687 = NL + "\t\t/**" + NL + "\t\t * The meta object literal for the '<em><b>";
  protected final String TEXT_688 = "</b></em>' ";
  protected final String TEXT_689 = " feature." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL + "\t\t */" + NL + "\t\t// CHANGE gen: Feature constant " + NL + "\t\t";
  protected final String TEXT_690 = " ";
  protected final String TEXT_691 = " = eINSTANCE.get";
  protected final String TEXT_692 = "();" + NL;
  protected final String TEXT_693 = NL + "\t\t/**" + NL + "\t\t * The meta object literal for the '<em><b>";
  protected final String TEXT_694 = "</b></em>' operation." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL + "\t\t */" + NL + "\t\t// CHANGE gen: Operation constant" + NL + "\t\t";
 ...
 */
    ...
    stringBuffer.append(genClass.getImportedMetaType());
    ...
    stringBuffer.append(genEnum.getImportedMetaType());
    ...
    stringBuffer.append(genDataType.getImportedMetaType());
