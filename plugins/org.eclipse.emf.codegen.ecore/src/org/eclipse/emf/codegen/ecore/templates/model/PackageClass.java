...
public class PackageClass
{
  ...
  protected final String TEXT_271 = NL + "\t// CHANGE gen: Class accessor" + NL + "\t";
  ...
  protected final String TEXT_300 = NL + "\t// CHANGE gen: Feature accessor" + NL + "\t";
  ...
  protected final String TEXT_334 = NL + "\t/**" + NL + "\t * Returns the factory that creates the instances of the model." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @return the factory that creates the instances of the model." + NL + "\t * @generated" + NL + "\t */";
  ...
  protected final String TEXT_339 = ")getEFactoryInstance();" + NL + "\t}";
  protected final String TEXT_340 = NL + "\t";
  protected final String TEXT_341 = " get";
  protected final String TEXT_342 = "();";
  protected final String TEXT_343 = NL;
  protected final String TEXT_344 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isCreated = false;" + NL + "" + NL + "\t/**" + NL + "\t * Creates the meta-model objects for the package.  This method is" + NL + "\t * guarded to have no affect on any invocation but its first." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void createPackageContents()" + NL + "\t{" + NL + "\t\tif (isCreated) return;" + NL + "\t\tisCreated = true;" + NL + "\t";
  protected final String TEXT_345 = NL + NL + "\t\t// Create classes and their features" + NL + "\t  ";
  protected final String TEXT_346 = NL + "\t\t";
  protected final String TEXT_347 = " = create";
  protected final String TEXT_348 = "(";
  protected final String TEXT_349 = ");" + NL + "\t";
  protected final String TEXT_350 = NL + "\t\t// CHANGE: Use raw type" + NL + "\t\tcreate";
  protected final String TEXT_351 = "(";
  protected final String TEXT_352 = ", ";
  protected final String TEXT_353 = ");" + NL + "\t";
  protected final String TEXT_354 = NL + "\t";
  protected final String TEXT_355 = NL + "\t  ";
  protected final String TEXT_356 = NL + "\t\tcreateEOperation(";
  ...
  protected final String TEXT_365 = NL + NL + "\t\t// Create enums" + NL + "\t  ";
  protected final String TEXT_366 = NL + "\t\t";
  protected final String TEXT_367 = " = createEEnum(";
  protected final String TEXT_368 = ");" + NL + "\t  ";
  protected final String TEXT_369 = NL + "\t";
  protected final String TEXT_370 = NL + "\t";
  protected final String TEXT_371 = NL + NL + "\t\t// Create data types" + NL + "\t  ";
  protected final String TEXT_372 = NL + "\t\t";
  protected final String TEXT_373 = " = createEDataType(";
  protected final String TEXT_374 = ");" + NL + "\t  ";
  protected final String TEXT_375 = NL + "\t";
  protected final String TEXT_376 = NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isInitialized = false;" + NL;
  protected final String TEXT_377 = NL + "\t/**" + NL + "\t * Complete the initialization of the package and its meta-model.  This" + NL + "\t * method is guarded to have no affect on any invocation but its first." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void initializePackageContents()" + NL + "\t{" + NL + "\t\tif (isInitialized) return;" + NL + "\t\tisInitialized = true;" + NL + "" + NL + "\t\t// Initialize package" + NL + "\t\tsetName(eNAME);" + NL + "\t\tsetNsPrefix(eNS_PREFIX);" + NL + "\t\tsetNsURI(eNS_URI);" + NL + "\t";
  protected final String TEXT_378 = NL + NL + "\t\t// Obtain other dependent packages" + NL + "\t  ";
  protected final String TEXT_379 = NL + "\t\t";
  protected final String TEXT_380 = " ";
  protected final String TEXT_381 = " = (";
  protected final String TEXT_382 = ")";
  protected final String TEXT_383 = ".Registry.INSTANCE.getEPackage(";
  protected final String TEXT_384 = ".eNS_URI);" + NL + "\t  ";
  protected final String TEXT_385 = NL + "\t";
  protected final String TEXT_386 = NL + "\t";
  protected final String TEXT_387 = NL + NL + "\t\t// Add subpackages" + NL + "\t  ";
  protected final String TEXT_388 = NL + "\t\tgetESubpackages().add(";
  protected final String TEXT_389 = ");" + NL + "\t  ";
  protected final String TEXT_390 = NL + "\t";
  protected final String TEXT_391 = NL + "\t";
  protected final String TEXT_392 = NL + "\t  ";
  protected final String TEXT_393 = NL + NL + "\t\t// Create type parameters" + NL + "\t";
  protected final String TEXT_394 = NL + "\t  ";
  protected final String TEXT_395 = NL + "\t";
  protected final String TEXT_396 = NL + "\t\t";
  protected final String TEXT_397 = " ";
  protected final String TEXT_398 = "_";
  protected final String TEXT_399 = " = addETypeParameter(";
  protected final String TEXT_400 = ", \"";
  protected final String TEXT_401 = "\");";
  protected final String TEXT_402 = NL + "\t";
  protected final String TEXT_403 = NL + "\t\taddETypeParameter(";
  ...
  protected final String TEXT_411 = NL + NL + "\t\t// Set bounds for type parameters" + NL + "\t";
  protected final String TEXT_412 = NL + "\t  ";
  protected final String TEXT_413 = NL + "\t";
  protected final String TEXT_414 = NL + "\t  ";
  protected final String TEXT_415 = NL + "\t\t";
  protected final String TEXT_416 = "g";
  protected final String TEXT_417 = " = createEGenericType(";
  protected final String TEXT_418 = ");" + NL + "\t";
  protected final String TEXT_419 = NL + "\t\tg";
  protected final String TEXT_420 = ".";
  protected final String TEXT_421 = "(g";
  protected final String TEXT_422 = ");" + NL + "\t";
  protected final String TEXT_423 = NL + "\t  ";
  protected final String TEXT_424 = NL + "\t\t";
  protected final String TEXT_425 = "_";
  protected final String TEXT_426 = ".getEBounds().add(g1);" + NL + "\t";
  protected final String TEXT_427 = NL + "\t  ";
  protected final String TEXT_428 = NL + "\t";
  protected final String TEXT_429 = NL + "\t  ";
  protected final String TEXT_430 = NL + NL + "\t\t// Add supertypes to classes" + NL + "\t  ";
  protected final String TEXT_431 = NL + "\t";
  protected final String TEXT_432 = NL + "\t  ";
  protected final String TEXT_433 = NL + "\t\t";
  protected final String TEXT_434 = ".getESuperTypes().add(";
  ...
  protected final String TEXT_442 = " = createEGenericType(";
  protected final String TEXT_443 = ");" + NL + "\t  ";
  protected final String TEXT_444 = NL + "\t\tg";
  protected final String TEXT_445 = ".";
  protected final String TEXT_446 = "(g";
  protected final String TEXT_447 = ");" + NL + "\t  ";
  protected final String TEXT_448 = NL + "\t";
  protected final String TEXT_449 = NL + "\t\t";
  protected final String TEXT_450 = ".getEGenericSuperTypes().add(g1);" + NL + "\t  ";
  protected final String TEXT_451 = NL + "\t";
  protected final String TEXT_452 = NL + "\t  ";
  protected final String TEXT_453 = NL + NL + "\t\t// Initialize classes";
  protected final String TEXT_454 = ", features, and operations; add parameters";
  protected final String TEXT_455 = " and features; add operations and parameters";
  protected final String TEXT_456 = NL + "\t  ";
  protected final String TEXT_457 = NL + "\t\tinitEClass(";
  protected final String TEXT_458 = ", ";
  protected final String TEXT_459 = "null";
  protected final String TEXT_460 = ".class";
  ...
  protected final String TEXT_472 = "g";
  protected final String TEXT_473 = " = createEGenericType(";
  protected final String TEXT_474 = ");" + NL + "\t  ";
  protected final String TEXT_475 = NL + "\t\tg";
  ...
  protected final String TEXT_483 = NL + "\t\tinitEReference(get";
  protected final String TEXT_484 = "(), ";
  protected final String TEXT_485 = "g1";
  ...
  protected final String TEXT_505 = NL + "\t\tget";
  protected final String TEXT_506 = "().getEKeys().add(";
  protected final String TEXT_507 = ".get";
  protected final String TEXT_508 = "());" + NL + "\t";
  protected final String TEXT_509 = NL + "\t  ";
  protected final String TEXT_510 = NL + "\t\tinitEAttribute(get";
  protected final String TEXT_511 = "(), ";
  protected final String TEXT_512 = "g1";
  ...
  protected final String TEXT_534 = "initEOperation(get";
  protected final String TEXT_535 = "()";
  protected final String TEXT_536 = "addEOperation(";
  ...
  protected final String TEXT_550 = "initEOperation(get";
  ...
  protected final String TEXT_563 = "initEOperation(get";
  ...
  protected final String TEXT_575 = "initEOperation(get";
  protected final String TEXT_576 = "()";
  protected final String TEXT_577 = "addEOperation(";
  ...
  protected final String TEXT_584 = "addETypeParameter(op, \"";
  ...
  protected final String TEXT_597 = NL + "\t\tt";
  protected final String TEXT_598 = ".getEBounds().add(g1);" + NL + "\t  ";
  ...
  protected final String TEXT_605 = "g";
  protected final String TEXT_606 = " = createEGenericType(";
  protected final String TEXT_607 = ");" + NL + "\t";
  protected final String TEXT_608 = NL + "\t\tg";
  protected final String TEXT_609 = ".";
  protected final String TEXT_610 = "(g";
  ...
  protected final String TEXT_615 = NL + "\t\taddEParameter(op, ";
  protected final String TEXT_616 = "g1";
  ...
  protected final String TEXT_626 = NL + "\t\taddEParameter(op, ";
  protected final String TEXT_627 = "g1";
  protected final String TEXT_628 = ".get";
  ...
  protected final String TEXT_637 = NL + "\t\taddEParameter(op, ";
  protected final String TEXT_638 = "g1";
  ...
  protected final String TEXT_651 = "g";
  protected final String TEXT_652 = " = createEGenericType(";
  protected final String TEXT_653 = ");" + NL + "\t  ";
  protected final String TEXT_654 = NL + "\t\tg";
  protected final String TEXT_655 = ".";
  protected final String TEXT_656 = "(g";
  protected final String TEXT_657 = ");" + NL + "\t  ";
  protected final String TEXT_658 = NL + "\t\taddEException(op, g";
  ...
  protected final String TEXT_663 = NL + "\t\taddEException(op, ";
  ...
  protected final String TEXT_670 = "g";
  protected final String TEXT_671 = " = createEGenericType(";
  protected final String TEXT_672 = ");" + NL + "\t  ";
  protected final String TEXT_673 = NL + "\t\tg";
  protected final String TEXT_674 = ".";
  protected final String TEXT_675 = "(g";
  protected final String TEXT_676 = ");" + NL + "\t  ";
  protected final String TEXT_677 = NL + "\t";
  protected final String TEXT_678 = NL + "\t\tinitEOperation(op, g1);" + NL + "\t  ";
  ...
  protected final String TEXT_685 = NL + NL + "\t\t// Initialize enums and add enum literals" + NL + "\t  ";
  protected final String TEXT_686 = NL + "\t\tinitEEnum(";
  protected final String TEXT_687 = ", ";
  protected final String TEXT_688 = ".class, \"";
  protected final String TEXT_689 = "\");";
  protected final String TEXT_690 = NL + "\t";
  protected final String TEXT_691 = NL + "\t\taddEEnumLiteral(";
  ...
  protected final String TEXT_700 = NL + NL + "\t\t// Initialize data types" + NL + "\t  ";
  protected final String TEXT_701 = NL + "\t\tinitEDataType(";
  protected final String TEXT_702 = ", ";
  protected final String TEXT_703 = ".class, \"";
  ...
  protected final String TEXT_712 = NL + NL + "\t\t// Create resource" + NL + "\t\tcreateResource(";
  protected final String TEXT_713 = ");" + NL + "\t";
  protected final String TEXT_714 = NL + "\t";
  protected final String TEXT_715 = NL + NL + "\t\t// Create annotations" + NL + "\t  ";
  protected final String TEXT_716 = NL + "\t\t// ";
  protected final String TEXT_717 = NL + "\t\tcreate";
  protected final String TEXT_718 = "Annotations();" + NL + "\t  ";
  protected final String TEXT_719 = NL + "\t";
  protected final String TEXT_720 = NL + "\t}" + NL + "" + NL + "\t";
  protected final String TEXT_721 = NL + "\t/**" + NL + "\t * Initializes the annotations for <b>";
  protected final String TEXT_722 = "</b>." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected void create";
  protected final String TEXT_723 = "Annotations()" + NL + "\t{" + NL + "\t\tString source = ";
  protected final String TEXT_724 = "null;";
  protected final String TEXT_725 = "\"";
  protected final String TEXT_726 = "\";";
  protected final String TEXT_727 = NL + "\t  ";
  protected final String TEXT_728 = NL + "\t";
  protected final String TEXT_729 = "\t" + NL + "\t\taddAnnotation" + NL + "\t\t  (";
  protected final String TEXT_730 = ", " + NL + "\t\t   source, " + NL + "\t\t   new String[] " + NL + "\t\t   {" + NL + "\t  ";
  ...
  protected final String TEXT_738 = NL + "\t\t   new ";
  protected final String TEXT_739 = "[] " + NL + "\t\t   {" + NL + "\t";
  protected final String TEXT_740 = NL + "\t\t\t ";
  protected final String TEXT_741 = ".createURI(";
  protected final String TEXT_742 = ".";
  protected final String TEXT_743 = "eNS_URI).appendFragment(\"";
  ...
  protected final String TEXT_749 = NL + "\t\taddAnnotation" + NL + "\t\t  (";
  protected final String TEXT_750 = ", " + NL + "\t\t   ";
  protected final String TEXT_751 = "new boolean[] { ";
  protected final String TEXT_752 = " }";
  protected final String TEXT_753 = "," + NL + "\t\t   ";
  protected final String TEXT_754 = "null,";
  protected final String TEXT_755 = "\"";
  protected final String TEXT_756 = "\",";
  protected final String TEXT_757 = NL + "\t\t   new String[] " + NL + "\t\t   {" + NL + "\t";
  ...
  protected final String TEXT_765 = NL + "\t\t   new ";
  protected final String TEXT_766 = "[] " + NL + "\t\t   {" + NL + "\t";
  protected final String TEXT_767 = NL + "\t\t\t ";
  protected final String TEXT_768 = ".createURI(";
  protected final String TEXT_769 = ".";
  protected final String TEXT_770 = "eNS_URI).appendFragment(\"";
  ...
  protected final String TEXT_778 = NL + "\t}" + NL + "" + NL + "\t";
  protected final String TEXT_779 = NL + "\t";
  protected final String TEXT_780 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isLoaded = false;" + NL + "" + NL + "\t/**" + NL + "\t * Laods the package and any sub-packages from their serialized form." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void loadPackage()" + NL + "\t{" + NL + "\t\tif (isLoaded) return;" + NL + "\t\tisLoaded = true;" + NL + "" + NL + "\t\t";
  protected final String TEXT_781 = " url = getClass().getResource(packageFilename);" + NL + "\t\tif (url == null)" + NL + "\t\t{" + NL + "\t\t\tthrow new RuntimeException(\"Missing serialized package: \" + packageFilename);";
  protected final String TEXT_782 = NL + "\t\t}" + NL + "\t\t";
  protected final String TEXT_783 = " uri = ";
  protected final String TEXT_784 = ".createURI(url.toString());" + NL + "\t\t";
  protected final String TEXT_785 = " resource = new ";
  protected final String TEXT_786 = "().createResource(uri);" + NL + "\t\ttry" + NL + "\t\t{" + NL + "\t\t\tresource.load(null);" + NL + "\t\t}" + NL + "\t\tcatch (";
  protected final String TEXT_787 = " exception)" + NL + "\t\t{" + NL + "\t\t\tthrow new ";
  protected final String TEXT_788 = "(exception);" + NL + "\t\t}" + NL + "\t\tinitializeFromLoadedEPackage(this, (";
  protected final String TEXT_789 = ")resource.getContents().get(0));" + NL + "\t\tcreateResource(eNS_URI);" + NL + "\t}" + NL + "" + NL + "\t";
  protected final String TEXT_790 = NL + NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprivate boolean isFixed = false;" + NL + "" + NL + "\t/**" + NL + "\t * Fixes up the loaded package, to make it appear as if it had been programmatically built." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tpublic void fixPackageContents()" + NL + "\t{" + NL + "\t\tif (isFixed) return;" + NL + "\t\tisFixed = true;" + NL + "\t\tfixEClassifiers();" + NL + "\t}" + NL + "" + NL + "\t/**" + NL + "\t * Sets the instance class on the given classifier." + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\t";
  protected final String TEXT_791 = NL + "\t@Override" + NL + "\t";
  protected final String TEXT_792 = NL + "\tprotected void fixInstanceClass(";
  protected final String TEXT_793 = " eClassifier)" + NL + "\t{" + NL + "\t\tif (eClassifier.getInstanceClassName() == null)" + NL + "\t\t{" + NL + "\t";
  protected final String TEXT_794 = NL + "\t";
  protected final String TEXT_795 = NL + "\t\t\teClassifier.setInstanceClassName(\"";
  protected final String TEXT_796 = ".\" + eClassifier.getName());";
  protected final String TEXT_797 = NL + "\t\t\tsetGeneratedClassName(eClassifier);" + NL + "\t";
  protected final String TEXT_798 = NL + "\t\t\tswitch (eClassifier.getClassifierID())" + NL + "\t\t\t{" + NL + "\t  ";
  ...
  protected final String TEXT_803 = NL + "\t\t\t\t{" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t\tdefault:" + NL + "\t\t\t\t{" + NL + "\t\t\t\t\teClassifier.setInstanceClassName(\"";
  protected final String TEXT_804 = ".\" + eClassifier.getName());";
  protected final String TEXT_805 = NL + "\t\t\t\t\tsetGeneratedClassName(eClassifier);" + NL + "\t\t\t\t\tbreak;" + NL + "\t\t\t\t}" + NL + "\t\t\t}" + NL + "\t";
  protected final String TEXT_806 = NL + "\t\t}" + NL + "\t}" + NL;
  protected final String TEXT_807 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
  protected final String TEXT_808 = " addEOperation(";
  protected final String TEXT_809 = " owner, ";
  protected final String TEXT_810 = " type, String name, int lowerBound, int upperBound, boolean isUnique, boolean isOrdered)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_811 = " o = addEOperation(owner, type, name, lowerBound, upperBound);" + NL + "\t\to.setUnique(isUnique);" + NL + "\t\to.setOrdered(isOrdered);" + NL + "\t\treturn o;" + NL + "\t}" + NL + "\t";
  protected final String TEXT_812 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\tprotected ";
  protected final String TEXT_813 = " addEParameter(";
  protected final String TEXT_814 = " owner, ";
  protected final String TEXT_815 = " type, String name, int lowerBound, int upperBound, boolean isUnique, boolean isOrdered)" + NL + "\t{" + NL + "\t\t";
  protected final String TEXT_816 = " p = ecoreFactory.createEParameter();" + NL + "\t\tp.setEType(type);" + NL + "\t\tp.setName(name);" + NL + "\t\tp.setLowerBound(lowerBound);" + NL + "\t\tp.setUpperBound(upperBound);" + NL + "\t\tp.setUnique(isUnique);" + NL + "\t\tp.setOrdered(isOrdered);" + NL + "\t\towner.getEParameters().add(p);" + NL + "\t\treturn p;" + NL + "\t}" + NL + "\t";
  protected final String TEXT_817 = NL + "\t/**" + NL + "\t * <!-- begin-user-doc -->" + NL + "\t * Defines literals for the meta objects that represent" + NL + "\t * <ul>" + NL + "\t *   <li>each class,</li>" + NL + "\t *   <li>each feature of each class,</li>";
  protected final String TEXT_818 = NL + "\t *   <li>each operation of each class,</li>";
  protected final String TEXT_819 = NL + "\t *   <li>each enum,</li>" + NL + "\t *   <li>and each data type</li>" + NL + "\t * </ul>" + NL + "\t * <!-- end-user-doc -->" + NL + "\t * @generated" + NL + "\t */" + NL + "\t";
  protected final String TEXT_820 = "public ";
  protected final String TEXT_821 = "interface Literals" + NL + "\t{";
  protected final String TEXT_822 = NL + "\t\t/**" + NL + "\t";
  protected final String TEXT_823 = NL + "\t  ";
  protected final String TEXT_824 = NL + "\t\t * The meta object literal for the '{@link ";
  protected final String TEXT_825 = " <em>";
  protected final String TEXT_826 = "</em>}' class." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @see ";
  protected final String TEXT_827 = NL + "\t  ";
  protected final String TEXT_828 = NL + "\t\t * The meta object literal for the '{@link ";
  protected final String TEXT_829 = " <em>";
  protected final String TEXT_830 = "</em>}' class." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @see ";
  protected final String TEXT_831 = NL + "\t  ";
  protected final String TEXT_832 = NL + "\t";
  protected final String TEXT_833 = NL + "\t\t * The meta object literal for the '{@link ";
  protected final String TEXT_834 = " <em>";
  protected final String TEXT_835 = "</em>}' enum." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @see ";
  protected final String TEXT_836 = NL + "\t";
  protected final String TEXT_837 = NL + "\t\t * The meta object literal for the '<em>";
  protected final String TEXT_838 = "</em>' data type." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t  ";
  protected final String TEXT_839 = NL + "\t\t * @see ";
  protected final String TEXT_840 = NL + "\t  ";
  protected final String TEXT_841 = NL + "\t";
  protected final String TEXT_842 = NL + "\t\t * @see ";
  protected final String TEXT_843 = "#get";
  protected final String TEXT_844 = "()" + NL + "\t\t * @generated" + NL + "\t\t */" + NL + "\t\t";
  ...
  protected final String TEXT_849 = NL + "\t\t/**" + NL + "\t\t * The meta object literal for the '<em><b>";
  protected final String TEXT_850 = "</b></em>' ";
  protected final String TEXT_851 = " feature." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL + "\t\t */" + NL + "\t\t // CHANGE gen: Feature constant " + NL + "\t\t";
  ...
  protected final String TEXT_857 = NL + "\t\t/**" + NL + "\t\t * The meta object literal for the '<em><b>";
  protected final String TEXT_858 = "</b></em>' operation." + NL + "\t\t * <!-- begin-user-doc -->" + NL + "\t\t * <!-- end-user-doc -->" + NL + "\t\t * @generated" + NL + "\t\t */" + NL + "\t\t // CHANGE gen: Operation constant" + NL + "\t\t";
